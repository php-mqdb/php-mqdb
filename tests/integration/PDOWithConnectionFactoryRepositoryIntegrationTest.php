...
class PDOWithConnectionFactoryRepositoryIntegrationTest extends TestCase
{
    use ConfigTrait;
    ...
    protected function setUp(): void
    {
        ...
        $connectionFactory = new ConnectionFactory(['common' => $config]);

        $repository = new PDOMessageRepository(connectionFactory: $connectionFactory, connectionName: 'common');
